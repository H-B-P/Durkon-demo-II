...
fancyWeddingCoeffs = {"No":1, "Somewhat":5, "Very":8}
...
def gen(nrow):
 ...
 for i in range(nrow):
  ...
  fancy = random.choice(["No"]*33+["Somewhat"]*51+["Very"]*10)
  
  if wedding=="Yes":
   height += 4
  
  price = (volume+roll_dX(20)-roll_dX(20)) * (flavCoeffs[flavour]+roll_dX(4)) * (10- abs(thickness-6))
